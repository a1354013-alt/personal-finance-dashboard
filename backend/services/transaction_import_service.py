...
HEADER_ALIASES = {
    ...
    "amount": {"amount", "金額", "金额", "交易金額", "交易金额", "支出金額", "支出金额", "收入金額", "收入金额"},
    "type": {
        "type",
        "cash_flow",
        "income_expense",
    ...
    "category": {"category", "分類", "分类", "類別", "类别", "支出分類", "支出分类", "收入分類", "收入分类"},
    "note": {"description", "note", "memo", "備註", "备注", "說明", "说明", "描述", "摘要"},
    "payment_method": {"payment_method", "payment method", "付款方式", "支付方式", "付款方法", "支付方法"},
}
