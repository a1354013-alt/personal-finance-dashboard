export default {
  ...
  stocks: {
    ...
    portfolio: {
      ...
      allocationValue: '{currency} allocation {value}%',
    ...
    trades: {
      ...
      formSubtitle: 'BUY and SELL entries replay FIFO lots immediately and refresh the projected holding.',
      stockCode: 'Stock Code',
      ...
      historySubtitle: 'Newest first, with filters for symbol, type, and trade date range.',
      applyFilters: 'Apply Filters',
      loading: 'Loading trades...',
      empty: 'No trades match the current filters.',
      summaryTitle: 'Realized P/L by Currency',
      summarySubtitle: 'Realized profit and loss stays grouped by native trade currency.',
      summaryEmpty: 'No realized trade activity yet.',
      created: 'Trade created.',
      updated: 'Trade updated.',
      deleted: 'Trade deleted.',
      managedThroughHoldings: '通过持仓管理',
      ...
      summary: {
        ...
        openingBalanceCount: 'Opening Balances',
        openingBalanceShares: 'Opening Shares',
        boughtShares: 'Bought Shares',
        soldShares: 'Sold Shares',
        grossProceeds: 'Gross Proceeds',
        matchedCostBasis: 'Matched Cost Basis',
        fees: 'Fees',
        taxes: 'Taxes'
      }
    },
